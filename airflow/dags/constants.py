...
FRIENDLY_NAMES = {UNI: "uni", UNISWAP_UNIVERSAL_ROUTER: "universal_router", UNISWAP_V2_ROUTER: "v2_router"}
...
TABLE_NAMES = {UNI: UNI_TABLE, UNISWAP_UNIVERSAL_ROUTER: UNIVERSAL_ROUTER_TABLE, UNISWAP_V2_ROUTER: V2_ROUTER_TABLE}
