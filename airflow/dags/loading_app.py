...
from constants import (
    FRIENDLY_NAMES, GCS_OBJECTS, TABLE_NAMES,
    TASK_IDS, DEFAULT_LOCATION
)
...
def create_dataset(task_id: str, dataset_id: str,                    location: str,                    gcp_conn_id: str = "google_cloud_default") -> BigQueryCreateEmptyDatasetOperator:
    """
...
def create_source_tasks(source_name: str, file_path: str, bucket_name: str, dataset_id: str, 
                        schema_fields: List[Dict], gcp_conn_id: str = "google_cloud_default") -> Dict:
    """
...
def create_loading_tasks(extraction_results: Dict[str, str], dataset_id: str = None, 
                         bucket_name: str = None, gcp_conn_id: str = "google_cloud_default") -> Dict:
    """
    ...
    dataset_creator = create_dataset(
        task_id=TASK_IDS["create_dataset"],
        dataset_id=dataset_id,
    ...
    for source_name, file_path in extraction_results.items():
        try:
            ...
            result["upload_load_pairs"].append({
                "uploader": source_tasks["uploader"],
                "loader": source_tasks["loader"]
            })
...
def set_task_dependencies(loading_tasks):
    """
